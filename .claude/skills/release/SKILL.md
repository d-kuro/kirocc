...
Tell the user: "PR を作成しました。CI が通ったらマージしてください。マージ後に `/release <version>` を再度実行するか、Phase 2 の手順を伝えてください。"
...
Tell the user: "タグを push しました。GitHub Actions の Release ワークフローが自動でビルドと公開を行います。"
