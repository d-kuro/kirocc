...
func (a *responseAccumulator) TruncationInput() TruncationInput {
	return TruncationInput{
		HasMetadata:     a.HasMetadata,
		HasContextUsage: a.HasContextUsage,
		HasText:         a.HasText,
		HasToolUse:      a.HasToolUse,
		ToolParseError:  a.ToolParseError,
		LocalStop:       a.LocalStop,
	}
}
...
func (a *responseAccumulator) FinalizeStream() (textDelta, thinkingDelta string) {
	...
	if remaining := a.flushStopSeqPending(); remaining != "" {
